...
class Category(models.Model):
    ...
    class Meta:
        ordering=('name',)
        verbose_name='category' # what is read
...
class Product(models.Model):
    ...
    category=models.ForeignKey(Category,on_delete=models.CASCADE)#previous data are delete
    img=models.ImageField(upload_to='category',blank=True)
    ...
    class Meta:
        ordering=('name',)
        verbose_name='product' # what is read
